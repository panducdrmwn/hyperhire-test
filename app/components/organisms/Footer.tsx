...
export default function Footer({
  ...
  return (
    <footer className='bg-[rgba(251,251,251,1)] flex flex-col px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-[300px] py-12 sm:py-16 md:py-20'>
        ...
        <div className='grid grid-cols-2 grid-rows-3 sm:grid-cols-4 sm:grid-rows-1 lg:grid-cols-4 gap-4 sm:gap-6 w-full pt-8 sm:pt-10 md:pt-14'>
           ...
           <div className='flex flex-col gap-2 row-start-3 col-span-2 md:col-auto md:row-auto'>
