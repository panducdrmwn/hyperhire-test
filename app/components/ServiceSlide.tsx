      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div className="flex flex-row items-center gap-3 sm:gap-4 md:gap-6 p-3 sm:p-4 bg-[rgba(255,255,255,0.2)] sm:w-[332px] md:w-[332px] lg:w-[290px] xl:w-[20vw] 2xl:w-[calc(22vw-95px)] h-[72px] sm:h-[80px] md:h-[88px] rounded-xl sm:rounded-xl">
              <Image
                src={slide.image}
                width={56}
                height={56}
